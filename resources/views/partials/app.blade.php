...
<body id="page-top">
    ...
    @if (Session::has('successloginuser'))
        <script>
            toastr.success('Berhasil Login Sebagai Member', '')
        </script>
    @endif
    @if (Session::has('successloginmanager'))
        <script>
            toastr.success('Berhasil Login Sebagai Manager', '')
        </script>
    @endif
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #121212;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="mx-3 sidebar-brand-text">Taskflow</div>
            </a>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Proyek baru telah ditambahkan!</span>
                                    </div>
                                </a>
                            </div>
                        </li>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="my-auto text-center copyright">
                        <span>Copyright &copy; Taskflow</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
